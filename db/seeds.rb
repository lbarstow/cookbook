...
if User.all.length < 1
  ...
  User.create(name: "Tom", email: "t@t.com", password: "verysecure")
end

if Recipe.all.length < 1
  Recipe.create(title: "tea", body: "add boiling water to \na mug with a tea bag", author_id: 1)
  Recipe.create(title: "Maple Corn Plops", body:"1 ½ c	flour \n 1 ½ c	cornmeal (5.8 oz) \n
                1 ½ T	baking powder\n3/8 t	salt\n8 T	margarine\n3/8 c	maple syrup\n
                ...
                source: "Biscuits and Scones by Elizabeth Alston", author_id:1)
  Recipe.create(title: "Mournful Oatmeal", body: "3 c 	water\n¼ t	salt\n1 c	steel-cut oats\n1 c	milk
                ...
                author_id: 1)
  Recipe.create(title:"No-Knead White Bread", body:"20 oz (4c) white flour (all-purpose or bread)
                \n1/3 t instant dry yeast (see notes)\n0.30 oz (2t) salt\n12.5 oz (1-½ c) water
                \n0.8 oz (1-½ T) white vinegar\nMix dry ingredients in large bowl. Add liquids and mix until the dough forms a ball and no dry flour
...
Knead 10 to 15 times on lightly floured surface. (Sprinkle with more flour as necessary to keep it from
sticking too much.)
Form the dough into a smooth ball and place it on parchment paper in 8” (or 10”) skillet. Cover with
plastic wrap. Let rise for 2 hours.
30 minutes before end of rise, turn the oven to 450 and put Dutch oven (or equivalent) and lid in the
oven to preheat. Put the lid beside the pan or at least tilted on top so air can circulate in the pan.
At the end of the rise, turn temperature down to 400.
Sprinkle a bit of flour on top of loaf, slash with sharp knife so the bread will crack where you want it
to. (I do three parallel slashes.) Remove the preheated pan from the oven. Be very careful – it’s
blazing hot! Place bottom of springform pan in the pan, lift dough into pan using parchment paper
as sling, cover, and bake 45 minutes.
Uncover and bake another 3-6 minutes until browned to the level you like. Internal temperature should
be 203-210.
Wait at least one incredibly long hour before cutting.
The bread lasts best if it’s simply placed cut-side down, rather then enclosed in a plastic or paper bag.
\nNotes: I use instant dry yeast but active dry yeast (“normal” yeast) works fine. Just increase the yeast a little bit, from ¼
...
Sauté garlic in oil over very low heat for 5-10 minutes. Add (including oil) with wet ingredients.", author_id: 2)
  Recipe.create(parent_recipe_id: 4, title: "Herb", body: "2 t dried herbs (oregano and rosemary both work well)\n
  Add the herb to the dry ingredients.\nIf you have fresh herbs,
  use triple the amount shown and dice them.", author_id: 1)
end
